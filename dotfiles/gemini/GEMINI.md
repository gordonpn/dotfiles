...
These instructions apply to all work performed.
...
- **Cross-Platform Compatibility:** Most projects are shared between macOS and Linux. Always verify that commands and environment variables are wrapped in appropriate OS checks where necessary.
