...
- **Instruction Maintenance:** Always keep the project-specific `AGENTS.md` and global `~/.gemini/AGENTS.md` files updated with new patterns, preferences, or established workflows identified during the session.
